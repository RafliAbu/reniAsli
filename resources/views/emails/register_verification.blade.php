...
<head>
    <meta charset="utf-8">
    <title>Kode Verifikasi Registrasi</title>
    <style>
        ...
        .header { text-align: center; padding-bottom: 20px; border-bottom: 2px solid #1d4ed8; }
        .header h2 { color: #1d4ed8; margin: 0; font-size: 22px; }
        .header p { color: #64748b; margin: 4px 0 0 0; font-size: 14px; }
        .code-box { background: #eff6ff; border: 2px dashed #3b82f6; border-radius: 8px; font-size: 32px; font-weight: bold; letter-spacing: 6px; color: #1d4ed8; text-align: center; padding: 20px; margin: 25px 0; }
...
<body>
    <div class="container">
        ...
        <p>Terima kasih telah mendaftar di Sistem Pelayanan Administrasi Desa Balangka. Berikut adalah kode verifikasi akun Anda:</p>
        
        <div class="code-box">{{ $code }}</div>
        
        <p>Masukkan kode di atas pada halaman verifikasi registrasi untuk mengaktifkan akun Anda. Kode ini berlaku selama 15 menit.</p>
